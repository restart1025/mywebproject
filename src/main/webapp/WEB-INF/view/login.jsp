    ...
    <form class="forget-form" action="findPassword" method="post">
        ...
        <div class="form-group">
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="请输入邮箱" name="email"/>
            </div>
        </div>
        <div class="form-actions">
    ...
    <form class="register-form" action="register" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" placeholder="请输入地址" name="address"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" placeholder="请输入城市" name="city"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                <i class="fa fa-lock"></i>
                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="register_password" placeholder="请输入密码" name="password"/>
            </div>
        </div>
        <div class="form-group">
